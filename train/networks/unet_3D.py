...
class BiNet(nn.Module):
    def __init__(self, feature_scale=4, n_classes=21, in_channels=3):
        super(BiNet, self).__init__()

        self.net1 = unet_3D(feature_scale=feature_scale, n_classes=n_classes, in_channels=in_channels)
        self.net2 = unet_3D(feature_scale=feature_scale, n_classes=n_classes, in_channels=in_channels)
...
class TriNet(nn.Module):
    def __init__(self, feature_scale=4, n_classes=21, in_channels=3):
        ...
        self.net1 = unet_3D(feature_scale=feature_scale, n_classes=n_classes, in_channels=in_channels)
        self.net2 = unet_3D(feature_scale=feature_scale, n_classes=n_classes, in_channels=in_channels)
        self.net3 = unet_3D(feature_scale=feature_scale, n_classes=n_classes, in_channels=in_channels)
