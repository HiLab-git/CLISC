...
# 训练并评估模型
model_ft, best_acc = train_model(model, criterion, optimizer, exp_lr_scheduler, num_epochs=15)
print(best_acc)
torch.save(model_ft.state_dict(), f'/media/ubuntu/maxiaochuan/CLIP_SAM_zero_shot_segmentation/CLIP/resnet_model/aug_res50_{best_acc:.4f}.pth')
